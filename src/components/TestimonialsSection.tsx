...
const reviews: Review[] = [
  {
    ...
    text: "Jesse and David did a great job remodeling our bathroom. Very professional and friendly too. We have an older house and the two obstacles they ran into they did a great job figuring it out. Highly recommend",
  },
  {
    ...
    badge: "Reasonable price",
    text: "Mark and Dale did a great job. I am very happy with the work. Showed up at the exact time they said they would. Kept me updated on what they were doing and finished on time. Everyone was very friendly and pleasant to work with.",
  },
  {
    author: "Tim",
    meta: "2 reviews",
    timeAgo: "a month ago",
    text: "Couldn't be more pleased with my walk-in shower install! Fantastic process from start to finish. Mark and Dale were amazing and I truly appreciate their craft and my result!",
  },
  {
    author: "Suzanne Duong",
    meta: "Local Guide · 16 reviews · 3 photos",
    timeAgo: "4 months ago",
    text: "Mark and Dale did excellent work on our home. They clearly communicated with us, worked efficiently and are very professional. I highly recommend them for any home improvement projects. They educated us on how to continue to maintain our new home project. We had a pleasant experience.",
  },
  {
    author: "Linda Kemmerer",
    meta: "12 reviews",
    timeAgo: "5 months ago",
    text: "I just had my bathroom redone with removing a tub and shower and just replacing it with a shower. Owen & Dennis were great workers. They laid down tarps from my doorway through my living room, up the stairs and right into the bath.",
  },
  {
    author: "Barry Miller",
    meta: "1 review",
    timeAgo: "a month ago",
    text: "Mark and Dale were great. Very professional and respectful. The shower installation went very smoothly. Walls and fixtures look great. Thank you!",
  },
  {
  ...
  },
  {
    ...
    text: "We want to thank Owen and Dennis for our new bathtub install! We love how it turned out and are very pleased. They were top notch installers and were very clean also! Thank you!",
  },
  {
    ...
    timeAgo: "5 months ago",
    badge: "Reasonable price",
    text: "Kyle and Joe were friendly, respectful and did a great job. They removed the old bathtub and installed a shower. They got to the job site on time. They protected the floor they walked on to and from the bathroom and left everything clean.",
  },
  {
    author: "Darryl",
  ...
  },
  {
    ...
    timeAgo: "2 months ago",
    badge: "Reasonable price",
    text: "Owen and Dennis did an awesome job installing our new frameless shower. They were prompt, neat, extremely efficient, and a dog lover! We are extremely pleased. You get what you pay for.",
  },
  {
  ...
  },
  {
    ...
    timeAgo: "4 months ago",
    badge: "Reasonable price",
    text: "Jesse and David came and remodeled our ensuite. They were nothing but professional. They were very careful of our property and were very friendly. It was a three day project and they were always on time, despite the long commute.",
  },
  {
    author: "Ying Yang",
    meta: "7 reviews",
  ...
  },
  {
    ...
    badge: "Reasonable price",
    text: "Jesse and David did a great job with our shower and sink installation. Great attention to detail. A follow-up phone call several days after the installation was complete shows their concern for customer satisfaction. Would definitely recommend.",
  },
  {
    author: "Frank DeRosa",
    ...
    timeAgo: "2 months ago",
    badge: "Reasonable price",
    text: "Had my shower redone to make it more accessible and safe as we age. Plus wanted to upgrade and modernize the shower and remove shower doors. Nick and Tony arrived promptly at 7:30 and stayed until they were done in the late afternoon. We are very pleased.",
  },
  {
  ...
  },
  {
    ...
    timeAgo: "7 months ago",
    badge: "Reasonable price",
    text: "Excellent company to work with. From the first visit to their showroom to the completed tub to shower conversion. The installers Nick and Tony were prompt and very professional. They did excellent work.",
  },
  {
    ...
    timeAgo: "4 months ago",
    badge: "Reasonable price",
    text: "We are thrilled with the results of our complete bath remodel! Nick and Tony work so well together — they are extremely clean, careful and efficient while working. I HIGHLY recommend them.",
  },
  {
    ...
    timeAgo: "2 months ago",
    badge: "Reasonable price",
    text: "Owen and Dennis did an excellent job. Arrived at the appointment exactly on time. Placed blankets down throughout the house where needed. New shower looks amazing!",
  },
  {
  ...
  },
  {
    ...
    timeAgo: "a year ago",
    text: "Alicia came to my home with all samples. Explained everything to me. I picked out what I wanted. They came and installed everything. Explained everything as they installed. I asked questions and they answered them. Best experience ever.",
  },
];
