        ...
        <div className="flex justify-center lg:justify-end max-w-7xl mx-auto w-full px-4 sm:px-6 pb-8 sm:pb-12 lg:pb-16">
          <div className="w-full max-w-md bg-card/95 backdrop-blur-sm rounded-lg p-5 sm:p-6 lg:p-8 shadow-2xl">
            ...
            <form className="space-y-2.5 sm:space-y-3" onSubmit={(e) => e.preventDefault()}>
              ...
              <input type="email" placeholder="Email" className="w-full px-4 py-2.5 sm:py-3 border border-input rounded-sm bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-accent" />
              ...
              <textarea placeholder="Notes (leave blank if none)" rows={2} className="w-full px-4 py-2.5 sm:py-3 border border-input rounded-sm bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-accent resize-none" />
